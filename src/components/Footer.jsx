...
const Footer = () => {
  return (
    <footer className='w-full  bg-secondary_background text-black  pt-10'>
      ...
      <div className='flex justify-between px-0 mt-10  sm:mt-0 sm:px-20'>
        <div className='space-y-2 navLinks'>
          ...
          <ul><Link to='/'>Data Protection</Link></ul>
        ...
        <div className='space-y-2 navLinks'>
          ...
          <ul><Link to='/'>Contact</Link></ul>
        </div>
      </div>


      </div>
      <hr className='border-primary_gold border-2' />
