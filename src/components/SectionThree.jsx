...
const SingleComponent = ({position, number, title, description}) => {
    return (
        <div class="max-w-screen-xl px-4 py-0 mx-auto sm:px-6 lg:px-8">
                ...
                <div
                    class={`relative h-64 overflow-hidden rounded-lg sm:h-80 lg:h-full ${position === 'left' ? 'lg:order-last' : 'lg:order-first'}`}
                >
                    <img
                ...
                <div class="lg:py-24">
                    <h2 class="text-3xl font-bold sm:text-4xl text-green-900">{number}</h2>
